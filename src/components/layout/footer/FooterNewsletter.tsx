...
export default function FooterNewsletter() {
  ...
  return (
    <motion.div
      ...
      className="max-w-[980px] mx-auto px-5 pb-10"
    >
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
        ...
        <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 min-w-0 flex-1 max-w-md">
          ...
          <motion.button
            ...
            className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white text-[14px] font-medium rounded-[8px] transition-colors duration-200 whitespace-nowrap"
          >
      ...
      {subscribed && (
        <motion.p
          ...
          className="text-[12px] text-green-600 dark:text-green-400 mt-3 tracking-[-0.1px]"
        >
