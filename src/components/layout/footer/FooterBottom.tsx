  ...
  return (
    <>
      ...
      <div className="max-w-[980px] mx-auto px-5 pb-14">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-[12px] text-gray-500 dark:text-[#6e6e73] tracking-[-0.1px]">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            <span>© 2026 MedRex. All rights reserved.</span>
            <span>Made for better healthcare</span>
          </div>
