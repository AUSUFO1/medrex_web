...
const AppStoreBadge = () => (
  <a
    href="#download"
    className="flex items-center gap-2.5 border border-black/[0.12] dark:border-white/[0.12] rounded-[10px] px-4 py-2.5 hover:border-black/25 dark:hover:border-white/25 hover:opacity-75 active:scale-97 transition duration-200"
  ...
  return (
    <div className="max-w-[980px] mx-auto px-5 pt-14 pb-10 border-b border-black/[0.06] dark:border-white/[0.06]">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          <h2 className="text-[22px] font-semibold text-gray-900 dark:text-white tracking-[-0.5px] leading-snug">
            Healthcare, in your pocket.
          </h2>
          <p className="text-[14px] text-gray-500 dark:text-[#6e6e73] mt-1 tracking-[-0.1px]">
